...
public class CategoryServicesImp implements ICategoryService {
    ...
    public ResponseEntity<CategoryResponseRest> update(Category category, Long id) {
        ...
        try{
            ...
            e.getStackTrace();
            response.setMetadata("Response not ok", "-1", "Updating error");
            return new ResponseEntity<CategoryResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
        }
        return new ResponseEntity<CategoryResponseRest>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<CategoryResponseRest> delete(Long id) {
        ...
        try{
            ...
            response.setMetadata("Response ok", "00", "Category deleted by ID");
        } catch (Exception e){
            e.getStackTrace();
            response.setMetadata("Response not ok", "-1", "Deleting by ID error");
            return new ResponseEntity<CategoryResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
        }
        return new ResponseEntity<CategoryResponseRest>(response, HttpStatus.OK);
    }
